					...
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								...
								<h3 class="text-white mb-0 font-weight-500">340 <small class="text-success"><i class="fa fa-caret-up"></i>SAR</small></h3>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								...
								<h3 class="text-white mb-0 font-weight-500">3400 <small class="text-success"><i class="fa fa-caret-up"></i>SAR</small></h3>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								...
								<h3 class="text-white mb-0 font-weight-500">1,4 <small class="text-danger"><i class="fa fa-caret-up"></i></small></h3>
							</div>
						</div>
					</div>
				</div>
